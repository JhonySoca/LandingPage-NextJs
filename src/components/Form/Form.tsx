            ...
            <div className="py-4 px-3 rounded-lg shadow-light">
                ...
                <div className="my-5 ">
                    <div className="">
                        ...
                        <div className="mt-2 ">
                            <input type="text" name="name" className="w-full rounded-md border-0 py-1.5 text-secondary shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-0 focus:ring-inset text-sm"></input>
                        </div>
                    </div>
                </div>
                <div className="mt-2">
                ...
                <div className="flex justify-between gap-5 my-4">
                    <button className="bg-secondary px-4 py-2 text-white rounded-lg text-sm hover:bg-black">Enviar mensaje</button>
                    <button className="border-[1px] border-secondary text-secondary px-2 py-2 rounded-lg text-sm hover:bg-black">Llamar</button>
                </div>
            </div>
        </div>
    )
